        ...
        {allCategories.map((cat) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                toggleSelection(tripData.categories, "categories", categoryName)
              }
            >
              <input
                type="checkbox"
                checked={tripData.categories.includes(categoryName)}
                onChange={() =>
                  toggleSelection(tripData.categories, "categories", categoryName)
                }
              />
        ...
        {allCities.map((city) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                toggleSelection(tripData.cities, "cities", cityName)
              }
            >
              <input
                type="checkbox"
                checked={tripData.cities.includes(cityName)}
                onChange={() =>
                  toggleSelection(tripData.cities, "cities", cityName)
                }
              />

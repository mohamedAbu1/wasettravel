...
export default function BookingsList() {
  ...
  const bookings = [
    { user: "Sara", trip: "Pyramids Tour", date: "2026-01-05", status: "Confirmed" },
    { user: "Ahmed", trip: "Nile Cruise", date: "2026-02-12", status: "Pending" },
    { user: "Omar", trip: "Desert Safari", date: "2026-03-20", status: "Cancelled" },
  ];

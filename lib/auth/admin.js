...
// Temporary single-administrator policy requested for the live site.
export const PRIMARY_ADMIN_EMAIL = "wasettraveleg@gmail.com";
...
export function effectiveRole(user) {
  return isPrimaryAdmin(user) ? "ADMIN" : "USER";
}

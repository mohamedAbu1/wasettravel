...
export const fallbackCities = [
  ...
  { id: "cairo", name: JSON.stringify({ en: "Cairo", ar: "القاهرة", de: "Kairo", es: "El Cairo", fr: "Le Caire", it: "Il Cairo", zh: "开罗" }), images: JSON.stringify(["/Cairo/pexels-alexazabache-3290075.webp"]) },
...
export const fallbackCategories = [
  ...
  { id: "nile-cruise", name: JSON.stringify({ en: "Nile Cruises", ar: "رحلات نيلية", de: "Nilkreuzfahrten", es: "Cruceros por el Nilo", fr: "Croisières sur le Nil", it: "Crociere sul Nilo", zh: "尼罗河游轮" }), images: JSON.stringify(["/iamges/pexels-sahilcaptures-35645491.webp"]) },
  { id: "medical", name: JSON.stringify({ en: "Medical Trips", ar: "رحلات علاجية", de: "Medizinische Reisen", es: "Viajes médicos", fr: "Voyages médicaux", it: "Viaggi medici", zh: "医疗旅行" }), images: JSON.stringify(["/iamges/youhana-nassif-YBpSX76CQaE-unsplash.webp"]) },
];

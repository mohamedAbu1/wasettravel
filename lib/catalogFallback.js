...
export const fallbackCategories = [
  ...
  { id: "nile-cruise", name: JSON.stringify({ en: "Nile Cruises", ar: "رحلات نيلية", de: "Nilkreuzfahrten", es: "Cruceros por el Nilo", fr: "Croisières sur le Nil", it: "Crociere sul Nilo", zh: "尼罗河游轮" }), images: JSON.stringify(["/Nile%20Cruise/pexels-sahilcaptures-35645491.webp"]) },
  { id: "medical", name: JSON.stringify({ en: "Medical Trips", ar: "رحلات علاجية", de: "Medizinische Reisen", es: "Viajes médicos", fr: "Voyages médicaux", it: "Viaggi medici", zh: "医疗旅行" }), images: JSON.stringify(["/Medical%20trips/youhana-nassif-YBpSX76CQaE-unsplash.webp"]) },
];
